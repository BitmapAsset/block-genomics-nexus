...
const ROWS = [
  { y: '8%',  dir: 1,  speed: 35, blocks: [18,10,14,8,22,12,16,9,20,11,15,13,17,10,19,14,12,8,21,16] },
  { y: '32%', dir: -1, speed: 42, blocks: [12,20,8,16,14,10,22,13,18,9,15,11,19,17,8,14,21,10,13,16] },
  { y: '56%', dir: 1,  speed: 38, blocks: [16,9,21,12,18,14,8,20,11,15,13,10,17,22,9,16,12,19,14,8] },
  { y: '80%', dir: -1, speed: 45, blocks: [10,18,13,22,9,16,20,12,14,8,17,11,15,19,13,10,21,16,9,18] },
];
