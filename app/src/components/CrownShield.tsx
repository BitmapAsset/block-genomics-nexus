 ...
 *
 * The server-safe implementation lives in '@/lib/crown-shield-svg' because a
 * function exported from this 'use client' module cannot be invoked from a
 * server route handler (it throws across the RSC boundary in production).
 * Re-exported here so existing client-side imports keep working.
 */
export { crownShieldSVGString } from '@/lib/crown-shield-svg';
